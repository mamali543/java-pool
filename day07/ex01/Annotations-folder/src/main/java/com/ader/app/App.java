...
public class App 
{
    ...
    public static void main( String[] args ) throws ClassNotFoundException {
        ...
        for (Method method : methods) {
            String methodParamTypes = Arrays.toString(method.getParameterTypes());
            methodParamTypes = methodParamTypes.substring(1, methodParamTypes.length() - 1);
            if (inputField.equals(method.getName() + "(" + methodParamTypes + ")")) {
                int intValue = 0;
                if (!methodParamTypes.equals("")) {
                    System.out.print("Enter " + methodParamTypes + " value:\n-> ");
                    intValue = scanner.nextInt();
                }
                System.out.println("Method returned:");
                executeMethod(method, intValue);
            }
        }
    }
    ...
    private static void executeMethod(Method method, int anInt){
